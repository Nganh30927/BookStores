...
const BooksDetailsPage = () => {
  ...
  const queryBookDetails = useQuery<IBooks, Error>({
                ...
                <div className="w-full md:w-1/2 px-4 mb-12 md:mb-0">
                  <div className="max-w-3xl">
                    <div className="lg:flex h-full">
                      <div className="lg:flex-shrink-0 lg:w-20 mb-5 lg:mb-0 lg:mr-6"></div>
                      <div className="border-gray-300 border-4">
                        <img
                          className="block h-full w-full"
                          src={`http://localhost:9000` + `${books[0]?.imageURL}`}
                          alt=""
                          style={{ maxHeight: 650 }}
                ...
                <div className="w-full md:w-1/2 px-4">
                  <div className="max-w-md mx-auto">
                    ...
                    <div className="block text-lg  mb-6" data-config-id="auto-txt-2-3">
                      <span>Tác giả:</span> <span className="font-semibold">{books[0]?.author}</span>
                    </div>
                    <div className="block mb-8" data-config-id="auto-txt-2-3">
                      <span className="text-lg">Nhà xuất bản:</span> <span className="text-lg font-semibold text-blue-500">{books[0]?.publisher.name}</span>
                    </div>
                    <div className="block  mb-6" data-config-id="auto-txt-2-3">
                      <span className="text-red-600 text-xl font-semibold mr-1"> {books[0]?.price * (1 - books[0]?.discount / 100)} đ</span>{' '}
                      <del className="text-lg mr-1">{books[0]?.price} đ</del>
                      <span className="py-1 px-2 bg-red-600 text-white rounded-lg font-medium">{`-${books[0]?.discount}%`}</span>
                    </div>
            ...
            <div className="lg:grid-cols-[50%,1fr] grid grid-cols-1 gap-6">
              ...
              <div>
                <div className="p-6 bg-gray-100 rounded-md dark:bg-gray-900">
                  <h2 className="px-2 mb-6 text-2xl font-semibold text-left text-gray-600 dark:text-gray-400">Reviews and Q&A</h2>
                  <form className="">
