        ...
        <div className="py-4">
          <div className="container mx-auto px-4">
            <div>
              ...
              <a className="inline-block text-black" href="#" data-config-id="auto-txt-3-2">
                Books
              </a>
            </div>
          </div>
                      ...
                      ? books?.books.map((book: any) => {
                          return (
                            <div
                              ...
                              className="w-1/2 sm:w-1/2 md:w-1/3 xl:w-1/3 bg-white overflow-hidden group border border-gray-300 relative hover:border-yellow-200"
                            >
                              <div
                              ...
                              <div className="absolute right-6 bottom-5">
                                <div className="w-12 h-12  text-sky-500 hover:bg-sky-600 hover:text-white rounded-3xl border border-sky-500 flex items-center justify-center hidden lg:flex md:flex sm:hidden">
                                  <a
