            ...
            <div className="w-full lg:w-1/2 px-3 mb-6 lg:mb-0">
              <div className="mb-6 h-56 w-full rounded-xl overflow-hidden  bg-slate-100 border">
                ...
                >
                  ...
                  <SwiperSlide>
                    <img className="w-full h-full  rounded-xl" src="" alt="Slide 2" />
                  </SwiperSlide>
                </Swiper>
              </div>
            ...
            <div className="flex flex-wrap items-center ">
              <div className="w-full lg:w-1/3">
                <a className="group block h-full relative uppercase hover:italic" href="#">
                  ...
                  <div className="absolute bottom-0 left-0 p-8 w-full">
                    <h4 className="text-5xl font-black text-white" data-config-id="auto-txt-2-11">
                      Phone
                    </h4>
                  </div>
                </a>
              ...
              <div className="w-full lg:w-1/3 ">
                <a className="group block h-full relative uppercase hover:italic" href="#">
                  ...
                  />
                  <div className="absolute bottom-0 left-0 p-8 w-full">
                    <h4 className="text-5xl font-black text-white" data-config-id="auto-txt-4-11">
                      Laptop
                    </h4>
                  </div>
                </a>
