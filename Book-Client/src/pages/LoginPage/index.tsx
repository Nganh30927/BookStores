  ...
  return (
    <>
      <section
        ...
        data-component-id="6c5b97a6_06_awz"
        className="relative py-20 lg:py-10 overflow-hidden"
      >
            ...
            <div className="flex flex-wrap -mx-4 xl:items-end">
              <div className="w-full lg:w-1/2 px-4 order-last lg:order-first">
                <div className="relative max-w-md mx-auto lg:mx-0 lg:max-w-2xl h-full">
                  <img
                    className="block w-full h-166 sm:h-full object-cover rounded-3xl"
                    src="../../../public/images/image-yellow.png"
                    alt=""
              ...
              <div className="w-full lg:w-1/2 px-4 mb-16">
                <div className="max-w-md mx-auto lg:mr-0 lg:py-12 xl:py-0">
                  ...
                  <h3 className="font-heading text-4xl text-gray-900 font-semibold mb-4" data-config-id="auto-txt-4-6">
                    Sign in to your account
                  </h3>
                  <p className="text-lg text-gray-500 mb-10" data-config-id="auto-txt-5-6">
                  ...
                  <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    >
                      ...
                      <span className="relative" data-config-id="auto-txt-6-6">
                        {isSubmitting ? 'Submitting...' : 'Login'}
                      </span>
                    </button>
                    <div className="flex mb-6 items-center">
                      <div className="w-full h-px bg-gray-300"></div>
                      <span className="mx-4 text-sm font-semibold text-gray-500" data-config-id="auto-txt-7-6">
                        Or
                      </span>
                      <div className="w-full h-px bg-gray-300"></div>
                    </div>
                    <div className="mb-20">
                      <a
                        ...
                        href="#"
                      >
                        <span className="text-base mt-1 font-semibold text-gray-600">
                          <RiGoogleFill />
                        </span>
                        <span className="ml-4 text-sm font-semibold text-gray-600" data-config-id="auto-txt-8-6">
                          Login with Google
                        </span>
                      </a>
                      <a
                      ...
                      >
                        ...
                        <span className="ml-4 text-sm font-semibold text-gray-600" data-config-id="auto-txt-9-6">
                          Login with Facebook
                        </span>
                      </a>
                    </div>
                    <div className="text-center">
                      <span className="text-xs font-semibold text-gray-900">
                        ...
                        <a className="inline-block ml-1 text-orange-500 hover:text-orange-700" href="#" data-config-id="auto-txt-11-6">
                          Sign up
                        </a>
                      </span>
                    </div>
