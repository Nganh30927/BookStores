        ...
        return toast(
          <Link to={'/cart'} className="hover:text-red-400">
            <div className="flex items-center justify-center">
              <img src={`../../../images/${item.thumb}`} alt={item.name} className="w-16 h-16 mr-4" />
              <div>
  ...
  return (
    <>
      ...
      <div className="container mx-auto bg-slate-200">
                ...
                <div className=" top-0 overflow-hidden gap-8 py-10 md:gap-8">
                  ...
                  {isThumbOpen && (
                    <div className="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 inset-0 z-50 outline-none focus:outline-none justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                      <div className="opacity-75 w-screen h-screen fixed  z-40 bg-black"></div>
                      <div className="absolute top-16 min-w-fit container mx-auto xl:flex flex-col gap-8 justify-center  z-50" id="light-2">
                        <div
                          ...
                          <div className="flex items-center justify-center w-[35%] rounded-xl m-auto bg-orange xl:w-[28%]">
                            ...
                            >
                              <svg
                                ...
                                id="previous"
                              >
                                <path d="M11 1 3 9l8 8" strokeWidth={3} fill="none" fillRule="evenodd" id="previous" />
                              </svg>
                            </button>
                            <img src={`../../../images/image-product-${activeThumbnail}.jpg`} alt="sneaker" className="rounded-xl" id="hero-lightbox" />
                            ...
                            >
                              <svg
                                ...
                                id="next"
                              >
                                <path d="m2 1 8 8-8 8" strokeWidth={3} fill="none" fillRule="evenodd" id="next" />
                              </svg>
                            </button>
                          </div>
                        </div>
                          ...
                          {thumbnails.map((index) => (
                            <div
                              ...
                              className={`w-1/5 cursor-pointer rounded-xl sm:w-28 md:w-32 lg:w-[72px] xl:w-[78px] ${
                                activeThumbnail === index ? styles.ring_active : ''
                              }`}
                  ...
                  <picture className="relative flex items-center bg-orange-500 sm:bg-transparent" onClick={toggleThumb}>
                    ...
                    <img
                      src={`../../../images/image-product-${activeThumbnail}.jpg`}
                      alt="sneaker"
                ...
                <div className="lg:pl-20">
                  <div className="mb-6 ">
                    ...
                    <p className="inline-block text-2xl font-semibold text-gray-700 dark:text-gray-400 ">
                      ...
                      <span className="ml-3 text-base font-normal text-gray-500 line-through dark:text-gray-400">{product?.data.salePrice}</span>
                    </p>
                  </div>
                  <div className="mb-6">
                    <h2 className="mb-2 text-lg font-bold text-gray-700 dark:text-gray-400">Thông tin sản phẩm:</h2>
                      ...
                      <div className="py-2 px-3">
                        ...
                        >
                          <div className="overflow-hidden">
                            <span>
                              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Amet corrupti nesciunt cum laudantium dolorum natus doloremque
                              recusandae necessitatibus. Voluptatibus, autem sit eum nam quidem deleniti doloremque asperiores tempore dignissimos. Asperiores.
                            </span>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="py-6 mb-6 border-t border-gray-200 dark:border-gray-700"></div>
                  <div className="mb-6 " />
            ...
            <div className="lg:grid-cols-[50%,1fr] grid grid-cols-1 gap-6">
              <div>
                <div className="p-6 mb-6 bg-gray-100 rounded-md lg:p-6 dark:bg-gray-900">
                  <div className="items-center justify-between block mb-4 lg:flex">
                    <div className="flex flex-wrap items-center mb-4 lg:mb-0">
                      ...
                      />
                      <div>
                        <h2 className="mr-2 text-lg font-medium text-gray-700 dark:text-gray-400">Isha Singh</h2>
                ...
                <div className="p-6 mb-6 bg-gray-100 rounded-md lg:p-6 dark:bg-gray-900">
                  <div className="items-center justify-between block mb-4 lg:flex">
                    <div className="flex flex-wrap items-center mb-4 lg:mb-0">
                      <img className="object-cover mb-1 mr-2 rounded-full shadow w-14 h-14 lg:mb-0" src="https://i.postimg.cc/Qt3CFq04/7294794.jpg " />
                      <div>
                        <h2 className="mr-2 text-lg font-medium text-gray-700 dark:text-gray-400">Siya Smith</h2>
                        <p className="text-sm font-medium text-gray-400 dark:text-gray-400"> 12, SEP 2022 </p>
                      </div>
                    </div>
                    <div>
              ...
              <div>
                <div className="p-6 bg-gray-100 rounded-md dark:bg-gray-900">
                  <h2 className="px-2 mb-6 text-2xl font-semibold text-left text-gray-600 dark:text-gray-400">Leave a comment</h2>
                  <form className="">
        ...
        <section data-section-id={1} data-share="" data-category="ecommerce-gallery" data-component-id="4c009313_02_awz" className="py-10 ">
                ...
                >
                  <SwiperSlide>
                    <div className="p-10 xl:px-9  h-full bg-white rounded-3xl border border-gray-200">
                      ...
                      <a href="#">
                        <p className="mb-4 text-lg leading-8  font-medium hover:text-red-600" data-config-id="auto-txt-5-2">
