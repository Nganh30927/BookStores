              ...
              <button
                onClick={() => {
                  ...
                  const pageUrl = encodeQueryData(queryString)
                    ? `/books/filter?` + encodeQueryData(queryString) + `&maxPrice=100000`
                    : `/books/filter?` + `maxPrice=100000`;
                  navigate(pageUrl);
                }}
            ...
            <li className="mb-2 py-1 px-2 hover:bg-slate-100 font-medium">
              <button
                onClick={() => {
                  queryString = { ...queryString };
                  const pageUrl = encodeQueryData(queryString)
                    ? `/books/filter?` + encodeQueryData(queryString) + `&minPrice=100000&maxPrice=200000`
                    : `/books/filter?` + `minPrice=100000&maxPrice=200000`;
                  navigate(pageUrl);
                }}
                className={
            ...
            <li className="mb-2 py-1 px-2 hover:bg-slate-100 font-medium">
              <button
                onClick={() => {
                  queryString = { ...queryString };
                  const pageUrl = encodeQueryData(queryString)
                    ? `/books/filter?` + encodeQueryData(queryString) + `&minPrice=200000&maxPrice=250000`
                    : `/books/filter?` + `minPrice=200000&maxPrice=250000`;
                  navigate(pageUrl);
                }}
                className={
            ...
            <li className="mb-2 py-1 px-2 hover:bg-slate-100 font-medium">
              <button
                onClick={() => {
                  queryString = { ...queryString };
                  const pageUrl = encodeQueryData(queryString)
                    ? `/books/filter?` + encodeQueryData(queryString) + `&minPrice=250000&maxPrice=300000`
                    : `/books/filter?` + `minPrice=250000&maxPrice=300000`;
                  navigate(pageUrl);
                }}
                className={
            ...
            <li className="mb-2 py-1 px-2 hover:bg-slate-100 font-medium">
              <button
                onClick={() => {
                  queryString = { ...queryString };
                  const pageUrl = encodeQueryData(queryString)
                    ? `/books/filter?` + encodeQueryData(queryString) + `&minPrice=300000`
                    : `/books/filter?` + `minPrice=300000`;
                  navigate(pageUrl);
                }}
