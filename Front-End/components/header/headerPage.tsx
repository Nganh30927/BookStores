    ...
    return (
        ...
        <nav className="relative py-8 bg-gray-900 z-10">
          <div className="flex items-center">
            <a className="inline-block text-lg font-bold" href="#"/>
              ...
              {/* <h1 className='text-white'><Link href={'/'}>LOGO</Link></h1> */}
            ...
            <ul className="hidden lg:flex ml-16 lg:w-auto lg:space-x-12">
              <li className="group">
                <a className="inline-block font-bold text-transparent bg-clip-text bg-gradient-href-r from-yellow-500 via-green-300 href-blue-500" href="#"/>
              ...
              <li className='group'>
                <a className="relative group inline-block  text-white hover:text-yellow-500 font-medium" href="#"/>
                  <span className='py-6 px-2' data-config-id="auto-txt-2-5"><Link href={'/products'}>Product</Link></span>
            ...
            <div className="hidden lg:inline-flex items-center ml-auto">
              ...
              <div className='relative group'>
                <div className='relative group'>
                  <Link className="mr-7 inline-flex items-center" href={'/cart'}>
                                          ...
                                          <div className="w-4/5 px-2">
                                            ...
                                            <div className="flex items-end justify-between">
                                              ...
                                              <a onClick={() => {
                                                ...
                                                className="inline-block text-sm font-bold text-transparent bg-clip-text bg-gradient-href-r from-gray-400 href-gray-400 hover:from-yellow-300 hover:via-green-300 hover:href-blue-500"
                                                href="#"
      ...
      <div className="hidden navbar-menu fixed top-0 left-0 bottom-0 w-5/6 max-w-sm z-50" data-config-id="toggle-mobile-2" data-config-target=".navbar-menu" data-config-className="hidden">
        ...
        <nav className="relative flex flex-col py-6 px-6 w-full h-full bg-white border-r overflow-y-auto">
          ...
          <div>
            <ul>
              <li className="mb-1"><a className="block p-4 font-medium text-black hover:bg-gray-50" href="#" data-config-id="auto-txt-25-5"/>Why Vendia?</li>
              <li className="mb-1"><a className="block p-4 font-medium text-black hover:bg-gray-50" href="#" data-config-id="auto-txt-26-5"/>Browse</li>
              <li className="mb-1"><a className="block p-4 font-medium text-black hover:bg-gray-50" href="#" data-config-id="auto-txt-27-5"/>Resources</li>
              <li className="mb-1"><a className="block p-4 font-medium text-black hover:bg-gray-50" href="#" data-config-id="auto-txt-28-5"/>Brands</li>
            </ul>
          </div>
